...
public class RiskManagerTests
{
    ...
    public void CalculateTest()
    {
        ...
        Assert.That(Math.Round(pairs.Select(i => i.TradeVolume).Sum(), 2), Is.EqualTo(100000.00).Within(0.1));

        Assert.That(Math.Round(pairs.Select(i => i.Weight).Sum(), 2), Is.EqualTo(1).Within(0.01));
    }
}